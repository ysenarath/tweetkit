...
class Spaces(object):
    ...
    def find_spaces_by_ids(self, ids, space_fields=None, expansions=None, user_fields=None, topic_fields=None):
        ...
        space_fields: list of {'created_at', 'creator_id', 'ended_at', 'host_ids', 'id', 'invited_user_ids', 'is_ticketed', 'lang', 'participant_count', 'scheduled_start', 'speaker_ids', 'started_at', 'state', 'subscriber_count', 'title', 'topic_ids', 'updated_at'}, optional
            A comma separated list of Space fields to display.
        expansions: list of {'creator_id', 'host_ids', 'invited_user_ids', 'speaker_ids', 'topic_ids'}, optional
        ...
        topic_fields: list of {'description', 'id', 'name'}, optional
    ...
    def find_spaces_by_creator_ids(self, user_ids, space_fields=None, expansions=None, user_fields=None, topic_fields=None):
    ...
    def search_spaces(self, query, state=None, max_results=None, space_fields=None, expansions=None, user_fields=None, topic_fields=None):
        """Search for Spaces.
        ...
        state: {'live', 'scheduled', 'all'}, optional
    ...
    def space_buyers(self, id, pagination_token=None, max_results=None, user_fields=None, expansions=None, tweet_fields=None):
    ...
    def space_tweets(self, id, max_results=None, tweet_fields=None, expansions=None, media_fields=None, poll_fields=None, user_fields=None, place_fields=None):
